							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-9 form-inline">
									...
									<div class="input-group">
										...
										<select name="recurring_type" class="form-control recurring_type" disabled>
										...
										<select name="recurring_times" class="hidden recurring_times form-control" <?php echo ($transaction->getRecurringTransactions->count() > 1 ) ? 'disabled' : '' ?>>											

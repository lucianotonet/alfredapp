<div class="panel panel-primary">
    ...
    <div class="panel-heading">
        <h3 class="title pull-left">Fornecedor</h3>
        ...
        <div class="panel-body">
            ...
            {{ Form::model($fornecedor, [ 'method' => 'GET' ] ) }}   
            <div class="row">
        ...
        <div class="panel-footer">
            ...
            <div class="btn-toolbar" role="toolbar">
                ...
                {{ Form::open(array('url' => 'fornecedors/' . $fornecedor->id, 'class' => '')) }}
                    <div class="btn-group btn-group-lg pull-right">               
                        
                        {{ Form::button('<i class="fa fa-times"></i> Excluir', array('class' => 'btn btn-danger btn-lg btn-brick', 'type'=>'sumbit', 'onclick'=>'javascript:return confirm("Deseja excluir este fornecedor da lista?")')) }}

                        {{ Form::hidden('_method', 'DELETE') }}

                        <a href="{{ url('/fornecedors/'.$fornecedor->id.'/edit') }}" class="btn btn-info btn-brick">

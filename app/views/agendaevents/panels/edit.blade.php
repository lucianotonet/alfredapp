<div class="panel panel-primary">
	...
	<div class="panel-body form-horizontal">		
			...
			<div class="col-sm-9">				
				...
				<div class="input-group">
					<span class="input-group-btn">
						...
						<input type="hidden" name="icon" id="" class="form-control" value="{{ $event->icon }}">
					</span>
					<input type="text" class="form-control money" name="title" placeholder="" aria-describedby="sizing-addon1" required="required" value="{{ $event->title }}">					
				</div>											
			</div>
		</div>						
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-md-9 col-lg-9 form-inline">
				...
				<div class="input-group">
					...
					<input type="date" name="date_start" id="date_start" class="form-control datepicker" value="{{ date( 'Y-m-d', strtotime( $event->date_start ) ) }}" required="required">

					<span class="input-group-addon bg-primary ">
						<i class="icon-clock"></i>
					</span>
					<input type="time" name="time_start" id="time_start" class="form-control" value="{{ $event->time_start }}" >
		...
		<div class="collapse" id="agendaevent_moreinfo">
			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-md-9 col-lg-9 form-inline">
					<div class="input-group">
						...
						<input type="date" name="date_end" id="date_end" class="form-control datepicker" value="{{ date( 'Y-m-d', strtotime( $event->date_end ) ) }}">
						<span class="input-group-addon bg-primary ">
							<i class="icon-clock"></i>
						</span>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea name="description" id="input" class="form-control text-uppercase" rows="5">{{ $event->description }}</textarea>
				</div>
			</div>
	...
	<div class="panel-footer navbar-inverse">	
		...
		<div class="btn-group btn-group-justified" role="group" aria-label="...">
			...
			<a href="{{url('agenda/'.$event->id.'/delete')}}" class="btn btn-danger" onclick="return confirm('Excluir este evento?')">

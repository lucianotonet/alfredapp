...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="index.html"><i class="icon-dashboard"></i><span>Clientes</span> </a> </li>
        <li><a href="reports.html"><i class="icon-list-alt"></i><span>Tarefas</span> </a> </li>
        <li><a href="guidely.html"><i class="icon-facetime-video"></i><span>Ajuda</span> </a></li>
        <li><a href="charts.html"><i class="icon-bar-chart"></i><span>Relatórios</span> </a> </li>

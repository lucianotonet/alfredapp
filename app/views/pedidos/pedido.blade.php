...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#3bafda">
    <tbody><tr>
        <td></td>
                ...
                <div class="content">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td width="33%">
                                    ...
                                    <p>
                                        {{ ($pedido->cliente->empresa && $pedido->cliente->nome ) ? $pedido->cliente->nome . '<br />' : '' }}
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>       
                            ...
                            <tr>
                                <td align="center">{{ $item['qtd'] }} {{ $item['unidade'] }}</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">                                    
                                    ...
                                    <h2 style="text-align:right;">
                                        <em style="font-size: 0.6em !important;">R$</em> {{$pedido->total}}
                                    </h2>                                                                            
                                </td>
                            </tr>
                        </tbody>

...
class TransactionsController extends \BaseController
{
    ...
    public function index()
    {
        ...
        return ('transactions.novo.index', compact('transactions', 'transactions_days', 'receitas', 'despesas', 'balance'));
    }
    ...
    public function lancamentos()
    {
        ...
        */
        ...
        Illuminate\Support\Facades\Session::Session::flash(('info', $info);
        ...
        */
        ...
        return ($view, compact('transactions', 'transactions_days', 'view', 'title', 'data', 'balance', 'labels'));
    ...
    public function create()
    {
        ...
        if (Request::ajax()) {
            return ('transactions.novo.'.$data['type'].'.create');
        } else {
            return ('transactions.create', compact('type'));
        }
    }
    ...
    public function show($id)
    {
        ...
        if (count($transaction) < 1) {
            ...
            if (Request::header('referer')) {
                ...
                return Illuminate\Support\Facades\Redirect::Redirect::to(('financeiro');
            }
        }
        ...
        if (Request::ajax()) {
            return ('transactions.novo.'.$transaction->type.'.show', compact('transaction', 'labels'));
        } else {
            return ('transactions.novo.'.$transaction->type.'.show', compact('transaction', 'labels'));
        }
        // return ('transactions.show', compact('transaction'));
    }
    ...
    public function edit($id)
    {
        ...
        if (Request::ajax()) {
            return ('transactions.novo.'.$transaction->type.'.edit', compact('transaction'));
        } else {
            return ('transactions.edit', compact('transaction'));
        }
    }
    ...
    public function confirmDestroy($id)
    {
        ...
        // return ('transactions.create');
        if (Request::ajax()) {
            return ('transactions.novo.delete', compact('transaction', 'transactions'));
        } else {
            return Illuminate\Support\Facades\Redirect::Redirect::to((URL::previous());
        }

...
class RelatoriosController extends \BaseController
{
    ...
    public function index()
    {
        ...
        return ('relatorios.index', compact('relatorios'));
    }
            ...
            */
                ...
                */
                ...
                if (@$_GET['cidade'] || @$_GET['status'] || @$_GET['from'] || @$_GET['to']) {
                    ...
                    $despesas = $despesas->filter(function ($despesa) {
                        ...
                        } elseif (@$_GET['status'] == 'nao-enviadas') {
                            if ($despesa->relatorio_id < 1) {
                                return $despesa;
                            }
                        } else {
                ...
                return ('relatorios.despesas.create', ['despesas' => $despesas]);
                break;
            ...
            case 'conversas':
                ...
                */
                ...
                return ('relatorios.conversas.create', ['status' => $status, 'filters' => $filters, 'search_results' => $search_results, 'message' => $message, 'conversas' => $conversas, 'relatorio' => new Relatorio, 'clientes' => $clientes]);
                break;

            default:
                //  se não informado um RESOURCE_NAME, a view CREATE padrão é chamada
                return ('relatorios.create');
                break;
    ...
    public function store()
    {
        ...
        return Illuminate\Support\Facades\Redirect::Redirect::to((url('relatorios/'.$relatorio->id));
    ...
    public function show($id)
    {
        ...
        switch ($relatorio->type) {
            case 'despesas':
                ...
                // TESTE PARA PDF
                // return ('relatorios.despesas.pdf', compact('relatorio'));
                // return ('relatorios.despesas.print', compact('relatorio'));
                return ('relatorios.despesas.show', compact('relatorio'));
                break;
            ...
            case 'conversas':
                ...
                return ('relatorios.conversas.show', compact('relatorio'));
                break;

            default:
                return ('relatorios.show', compact('relatorio'));
                break;
    ...
    public function edit($id)
    {
        ...
        return ('relatorios.edit', compact('relatorio', 'total'));
    }
    ...
    public function update($id)
    {
        ...
        return Illuminate\Support\Facades\Redirect::Redirect::route(('relatorios.index');
    }
    ...
    public function streampdf($id)
    {
        ...
        if (! $relatorio) {
            ...
            if (URL::previous()) {
                ...
                return Illuminate\Support\Facades\Redirect::Redirect::to(('relatorios');
            }
        }
    ...
    public function printThis($id)
    {
        ...
        return ('relatorios.'.$relatorio->type.'.print', compact('relatorio'));

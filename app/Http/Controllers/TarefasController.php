...
class TarefasController extends \BaseController
{
    ...
    public function index()
    {
        ...
        if (Route::is('tarefas.print')) {
            return ('tarefas.print', compact('tarefas'));
        } else {
            return ('tarefas.index', compact('tarefas'));
        }
    }
    ...
    public function create()
    {
        ...
        if (Request::ajax()) {
            return ('tarefas.panels.create', compact('conversa', 'cliente'));
        } else {
            return ('tarefas.create', compact('conversa', 'cliente'));
        }
    }
    ...
    public function store()
    {
        ...
        //        return $tarefa;
        //     }
        // return Illuminate\Support\Facades\Redirect::Redirect::route(('tarefas.index');
    ...
    public function show($id)
    {
        ...
        if (Request::ajax()) {
            return ('tarefas.panels.show', compact('tarefa'));
        }

        return ('tarefas.show', compact('tarefa'));
    }
    ...
    public function edit($id)
    {
        ...
        return ('tarefas.edit', compact('tarefa'));
    }

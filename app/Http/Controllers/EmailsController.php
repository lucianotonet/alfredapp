...
class EmailsController extends \BaseController
{
    ...
    public function index()
    {
        ...
        return ('emails.index', compact('emails'));
    }
    ...
    public function create()
    {
        ...
        */
        ...
        if (Request::ajax()) {
            return ('emails.panels.create', compact('email', 'resource'));
        } else {
    ...
    public function store()
    {
        ...
        foreach ($data['to'] as $to) {
            ...
            // DEBUG
            // return ( $view, array('email'=>$content, 'resource'=>$resource) );
            // exit;
    ...
    public function show($id)
    {
        ...
        return ('emails.show', compact('email'));
        // return ('layouts.email', compact('email'));
    }
    ...
    public function edit($id)
    {
        ...
        return ('emails.edit', compact('email'));
    }
    ...
    public function update($id)
    {
        ...
        return Illuminate\Support\Facades\Redirect::Redirect::route(('emails.index');
    }

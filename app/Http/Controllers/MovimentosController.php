...
class MovimentosController extends \BaseController
{
    ...
    public function index()
    {
        ...
        return ('movimentos.index', compact('movimentos'));
    }
    ...
    {
        if (Request::ajax()) {
            return ('movimentos.panels.create');
        } else {
            return ('movimentos.create');
        }
    }
    ...
    public function store()
    {
        ...
        return Illuminate\Support\Facades\Redirect::Redirect::route(('movimentos.index');
    }
    ...
    public function show($id)
    {
        ...
        return ('movimentos.show', compact('movimento'));
    }
    ...
    public function edit($id)
    {
        ...
        return ('movimentos.edit', compact('movimento'));
    }

...
class ProdutosController extends \BaseController
{
    ...
    public function index()
    {
        ...
        return ('produtos.index', compact('produtos', 'categories'));
    }
    ...
    public function store()
    {
        ...
        return Illuminate\Support\Facades\Redirect::Redirect::back(()->withErrors($validator)->withInput(\Illuminate\Support\Facades\Request::all());
    }
    ...
    public function show($id)
    {
        ...
        if ($produto) {
            ...
            if (Request::ajax()) {
                ...
                return ('produtos.panels.edit', compact('produto'));
            } else {
                return ('produtos.edit', compact('produto'));
            }
        }
    ...
    public function edit($id)
    {
        ...
        if (Request::ajax()) {
            return ('produtos.panels.edit', compact('produto', 'categories'));
        } else {
            return ('produtos.edit', compact('produto', 'categories'));
        }
    }
    ...
    public function update($id)
    {
        ...
        return Illuminate\Support\Facades\Redirect::Redirect::route(('produtos.index');
    }
    ...
    public function categories()
    {
        ...
        if (Request::ajax()) {
            // return Response::json( $produto );
            return ('produtos.panels.categories', compact('categories'));
        } else {
            return ('produtos.categories', compact('categories'));
        }
    }
    ...
    public function acabamentos()
    {
        ...
        if ($acabamentos) {
            ...
            if (Request::ajax()) {
                // return Response::json( $produto );
                return ('produtos.panels.acabamentos', compact('produtos', 'acabamentos'));
            } else {
                return ('produtos.index', compact('produtos', 'acabamentos'));
            }
        }
        $alert[] = ['class' => 'alert-danger',

...
class PedidosController extends \BaseController
{
        ...
        if ($pedidos) {
            ...
            foreach ($pedidos as $pedido) {
                ...
                if (! $fornecedor) {
                    ...
                    return Illuminate\Support\Facades\Redirect::Redirect::to((url('pedidos/'.$pedido->id.'/edit'));
                }
            ...
            return ('pedidos.index', compact('pedidos', 'produtos', 'emails'));
        } else {
            $alert[] = ['class' => 'alert-warning',
    ...
    public function create($id = 0)
    {
        ...
        return ('pedidos.create', compact('cliente', 'produtos', 'fornecedores', 'vendedores', 'categories'));
    ...
    public function store()
    {
        ...
        if ($pedido) {
            ...
            return Illuminate\Support\Facades\Redirect::Redirect::route(('pedidos.show', compact('pedido'));
        } else {
            ...
            return Illuminate\Support\Facades\Redirect::Redirect::back(()->withErrors();
        }
    ...
    public function show($id)
    {
        ...
        if ($pedido) {
            ...
            return ('pedidos.show', compact('pedido', 'cliente', 'fornecedor', 'vendedor', 'produtos', 'pedido_itens'));
            ...
            // return Illuminate\Support\Facades\Redirect::Redirect::to(( URL::previous() )->withErrors($alert);
            return Illuminate\Support\Facades\Redirect::Redirect::to(('pedidos');
        }
    ...
    public function edit($id)
    {
        if ($id) {
            ...
            if ($pedido) {
                ...
                return ('pedidos.edit', compact('pedido', 'produtos', 'fornecedores', 'vendedores', 'categories'));
        ...
        return ('pedidos.edit', compact('pedido'));
    }
    ...
    public function update($id)
    {
        ...
        if ($validator->fails()) {
            ...
            return Illuminate\Support\Facades\Redirect::Redirect::back(()->withErrors($validator)->withInput($data);
        }
        ...
        return Illuminate\Support\Facades\Redirect::Redirect::route(('pedidos.index');
    }
    ...
    public function sendTo($id)
    {
        ...
        return ('pedidos.enviar', compact('pedido', 'fornecedores', 'vendedores', 'clientes'));
    }
    ...
    public function sendNow()
    {
        ...
        // return ('pedidos.email.index', compact('pedido','fornecedores'));
    ...
    public function preview($id)
    {
        ...
        return ('pedidos.email.preview', compact('pedido'));
    }
    ...
    public function printPreview($id)
    {
        ...
        return ('pedidos.print', compact('pedido'));
    }
}

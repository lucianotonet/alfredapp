...
@section('styles')
    <!--  CSS DA DEONSTRAÇÃO DO TEMPLATE -->
...
@section('content')
    ...
    <!--header-->
      <div class="topic" style=" background: url(http://lorempixel.com/1200/300) no-repeat center center; background-size: cover;">
        <div class="container">
          <h3>Documentação</h3>
...
@section('scripts')
    ...
    <?php echo HTML::script('js/site.min.js');   ?>
